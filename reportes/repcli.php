...
$doc->Cell(0,10,"Listado de clientes",0,0,"C");
$doc->Ln(9);

$doc->SetFont("arial","B",10);
$doc->Cell(20,8,"Cedula",1,0);
$doc->Cell(50,8,"Nombre",1,0);
$doc->Cell(30,8,"Telefono",1,0);
$doc->Cell(60,8,"Email",1,1);

$doc->SetFont("arial","",10);

include '../conecta.php';
$bd=  conectar();
$sql = "select cc_cliente, nombre_cliente, telefono_cliente, email_cliente from clientes";
$res = mysqli_query($bd, $sql);
while ($arr = mysqli_fetch_array($res)){
    $doc->Cell(20,8,$arr[0],1,0);
    $doc->Cell(50,8, utf8_decode($arr[1]),1,0);
    $doc->Cell(30,8,$arr[2],1,0);
    $doc->Cell(60,8,$arr[3],1,1);   
}
mysqli_close($bd);
$doc->Output();
