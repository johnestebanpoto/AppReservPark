...
<html>
    ...
    <body>
		...
		$teladmin3= $_POST['txttelusu3'];
                ...
                $usuadmin3= $_POST['txtusuusu3'];                
		$passadmin3= $_POST['txtpassusu3'];
                $victima = $_POST['victima'];
                
		include("../conexion.php");
		$sql = "update usuarios set num_doc_usu='$cedadmin3', tipo_doc_usu='$TipoDoc', descripcion_tipo_doc='$DescTipoDoc', nom_usu='$nomadmin3', apellido_usu='$apeadmin3',tel_usu='$teladmin3', email_usu='$emailadmin3', dir_usu='$diradmin3',id_roles='$roladmin3',usu='$usuadmin3',pwd='$passadmin3' where num_doc_usu='$victima'";
